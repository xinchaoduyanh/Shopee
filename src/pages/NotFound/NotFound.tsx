    ...
    <div className='h-screen w-screen bg-gray-100 flex items-center'>
      <div className='container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700'>
        <div className='max-w-md'>
          ...
          <p className='text-2xl mt-2 md:text-3xl font-light leading-normal'>Sorry we could not find this page. </p>
          <p className='mb-8 mt-2'>But dont worry, you can find plenty of other things on our homepage.</p>
          <Link
            to={path.home}
            className='px-4 py-4 bg-orange capitalize inline  text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue active:bg-blue-600 hover:bg-orange/80'
          >
            back to homepage
          </Link>
        </div>
